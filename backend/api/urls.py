...
from . import views
from .views import TagViewSet, ArticleViewSet,PortfolioListCreateView, PortfolioCompanyUpdateView
...
urlpatterns = [
    ...
    path('portfolio/company/<int:pk>/', PortfolioCompanyUpdateView.as_view(), name='portfolio_company_update_delete'),
    # Notes management
